...
//         {preview && <img src={preview} alt="Preview" style={{ maxWidth: '100%', marginTop: '10px', width:'400px' }} />}
//         </div>
//       </div>
//       {showForm && (
//         <div className="form-container">
...
//       setShowForm(true);
//       setShowModal(true); // Show custom alert box
...
//             <h2>Check Form Inputs</h2>
//             <p>Please review the form inputs before submitting.</p>
